...
public class FragmentFour extends ListFragment implements AdapterView.OnItemClickListener {
    View view;
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        header.setText("No new Receives");
...

    {
        ...
        protected String doInBackground(Void... params) {
            ...
            try {
                ...
                flag_loading = true;
                URL url = new URL(C_SERVER_PROD + "receives.php");
    ...
    public class listviewProximityAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = inflater.inflate(R.layout.received_layout, null);
